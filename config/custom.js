// Custom site scripts - ONLY LOADING SCREEN MODIFIED
document.addEventListener("DOMContentLoaded", () => {

  // [ALL YOUR ORIGINAL CODE - SMOOTH SCROLL, DARK MODE, FADE-INS, FLOATING TITLE - UNCHANGED]
  ...
  // Purple animations + ORBIT KEYFRAME
  ...
  // 20 PURPLE ORBITING STARS (REPLACES SNOWFLAKES)
  for (let i = 0; i < 20; i++) {
    ...
    star.style.setProperty('--orbit-r', (12 + Math.random() * 25) + 'px');
